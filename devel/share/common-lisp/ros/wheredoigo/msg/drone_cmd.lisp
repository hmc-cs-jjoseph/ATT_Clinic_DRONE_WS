...
(cl:defmethod cl:initialize-instance :after ((m <drone_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drone_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wheredoigo-msg:<drone_cmd> is deprecated: use wheredoigo-msg:drone_cmd instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <drone_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheredoigo-msg:data-val is deprecated.  Use wheredoigo-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'heights-val :lambda-list '(m))
(cl:defmethod heights-val ((m <drone_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheredoigo-msg:heights-val is deprecated.  Use wheredoigo-msg:heights instead.")
  (heights m))

(cl:ensure-generic-function 'channels-val :lambda-list '(m))
(cl:defmethod channels-val ((m <drone_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wheredoigo-msg:channels-val is deprecated.  Use wheredoigo-msg:channels instead.")
  (channels m))
