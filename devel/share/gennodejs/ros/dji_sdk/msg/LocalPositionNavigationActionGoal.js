...
class LocalPositionNavigationActionGoal {
  constructor() {
    this.header = new std_msgs.msg.Header();
    this.goal_id = new actionlib_msgs.msg.GoalID();
    this.goal = new LocalPositionNavigationGoal();
  }
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = LocalPositionNavigationGoal.serialize(obj.goal, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new LocalPositionNavigationActionGoal();
    ...
    tmp = LocalPositionNavigationGoal.deserialize(buffer);
    data.goal = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
...
module.exports = LocalPositionNavigationActionGoal;
