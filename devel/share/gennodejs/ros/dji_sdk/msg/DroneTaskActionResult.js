...
class DroneTaskActionResult {
  constructor() {
    this.header = new std_msgs.msg.Header();
    this.status = new actionlib_msgs.msg.GoalStatus();
    this.result = new DroneTaskResult();
  }

  static serialize(obj, bufferInfo) {
    // Serializes a message object of type DroneTaskActionResult
    // Serialize message field [header]
    bufferInfo = std_msgs.msg.Header.serialize(obj.header, bufferInfo);
    // Serialize message field [status]
    bufferInfo = actionlib_msgs.msg.GoalStatus.serialize(obj.status, bufferInfo);
    // Serialize message field [result]
    bufferInfo = DroneTaskResult.serialize(obj.result, bufferInfo);
    return bufferInfo;
  }

  static deserialize(buffer) {
    //deserializes a message object of type DroneTaskActionResult
    let tmp;
    let len;
    let data = new DroneTaskActionResult();
    ...
    tmp = DroneTaskResult.deserialize(buffer);
...
module.exports = DroneTaskActionResult;
