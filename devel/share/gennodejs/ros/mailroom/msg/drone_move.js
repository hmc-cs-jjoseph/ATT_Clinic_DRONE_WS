...
class drone_move {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = _serializer.float32(obj.local_x, bufferInfo);
    // Serialize message field [local_y]
    bufferInfo = _serializer.float32(obj.local_y, bufferInfo);
    // Serialize message field [height]
    bufferInfo = _serializer.float32(obj.height, bufferInfo);
    // Serialize message field [az_angle]
    bufferInfo = _serializer.float32(obj.az_angle, bufferInfo);
