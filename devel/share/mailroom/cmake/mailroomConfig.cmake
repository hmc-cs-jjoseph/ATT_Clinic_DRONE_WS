...
if(NOT "/home/attclinic/software/drone_ws/devel/include;/home/attclinic/software/drone_ws/src/mailroom/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mailroom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/attclinic/software/drone_ws/src/mailroom/${idir}'.  Ask the maintainer 'jesse <jjoseph@hmc.edu>' to fix it.")
    endif()
