...
if("TRUE" STREQUAL "TRUE")
  set(dji_sdk_SOURCE_PREFIX /home/attclinic/software/drone_ws/src/dji_sdk)
  set(dji_sdk_DEVEL_PREFIX /home/attclinic/software/drone_ws/devel)
  set(dji_sdk_INSTALL_PREFIX "")
  set(dji_sdk_PREFIX ${dji_sdk_DEVEL_PREFIX})
else()
  set(dji_sdk_SOURCE_PREFIX "")
  set(dji_sdk_DEVEL_PREFIX "")
  set(dji_sdk_INSTALL_PREFIX /home/attclinic/software/drone_ws/install)
...
if(NOT "/home/attclinic/software/drone_ws/devel/include;/home/attclinic/software/drone_ws/src/dji_sdk/include " STREQUAL " ")
  set(dji_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/home/attclinic/software/drone_ws/devel/include;/home/attclinic/software/drone_ws/src/dji_sdk/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Norman Li <norman.li@dji.com>, Arjun Menon <arjun.menon@dji.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/attclinic/software/drone_ws/src/dji_sdk/${idir}'.  Ask the maintainer 'Norman Li <norman.li@dji.com>, Arjun Menon <arjun.menon@dji.com>' to fix it.")
    endif()
